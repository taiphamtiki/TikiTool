...
class WaveLoadingIndicator: UIView {
    ...
    fileprivate let animationUnitTime = 0.02//重画单位时间, redraw unit time
    
    fileprivate let heavyColor = UIColor(red: 131/255.0, green: 189/255.0, blue: 74/255.0, alpha: 1.0)
    fileprivate let lightColor =  UIColor(red: 93/255.0, green: 145/255.0, blue: 68/255.0, alpha: 1.0)
    fileprivate let clipCircleColor = UIColor(red: 26/255.0, green: 31/255.0, blue: 36/255.0, alpha: 1.0)
    fileprivate let clipCircleFillColor = UIColor(red: 77/255.0, green: 80/255.0, blue: 88/255.0, alpha: 1.0)

    fileprivate var clipCircleLineWidth: CGFloat = 15
...
//        style.alignment = NSTextAlignmentCenter;
        ...
        if progress > 0.45 {
            attribute = [NSFontAttributeName : UIFont.systemFont(ofSize: progressTextFontSize,weight:6), NSForegroundColorAttributeName : UIColor.white,
